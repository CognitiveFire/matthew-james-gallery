...
export const sampleArtworks: Artwork[] = [
  ...
  },
  {
    ...
    materials: 'Acrylic on canvas',
    price: 10000,
    imageUrl: '/images/mars-harvest.png',
    dimensions: '50cm × 40cm',
    year: 2025,
    available: true,
    featured: true,
  ...
  },
  {
    ...
    materials: 'Acrylic on canvas',
    price: 10000,
    imageUrl: '/images/i-love-thai-food.jpg',
    dimensions: '50cm × 40cm',
    year: 2025,
    available: true,
    featured: true,
  ...
  },
  {
    ...
    materials: 'Acrylic on canvas',
    price: 10000,
    imageUrl: '/images/fragment-of-myself.png',
    dimensions: '50cm × 50cm',
    year: 2022,
    available: true,
    featured: false,
  ...
  },
  {
    ...
    materials: 'Acrylic on canvas',
    price: 10000,
    imageUrl: '/images/the-keyhole.png',
    dimensions: '60cm × 40cm',
    year: 2022,
    available: true,
    featured: false,
